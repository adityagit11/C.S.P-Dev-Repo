...
import org.edelweiss.mongo.model.DataInvasion;
import org.edelweiss.mongo.model.MongoPatch;
...
public class MongoTest1 
{
	public static void main(String args[])
	{
		...
		DataInvasion createCollection = new DataInvasion();
		
		createCollection.setPatch(newPatch);
